...
model = myModel()
print(model.summary())
history=model.fit(dataGen.flow(X_train,y_train,batch_size=batch_size_val),steps_per_epoch= ,epochs=epochs_val,validation_data=(X_validation,y_validation),shuffle=1)
...
pickle_out= open("model_trained_{}.p".format(epochs_val),"wb")  # wb = WRITE BYTE
